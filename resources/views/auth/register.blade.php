                        ...
                        <div class="card-body p-4 p-lg-6 text-black">
                          ...
                          <form action="/register" method="POST">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input type="text" name="username" id="username" class="form-control" required autocomplete="disable"/>
                            </div>

                            <div class="form-outline mb-4">
                              <label class="form-label" for="email">Email</label>
                              <input type="email" name="email" id="email" class="form-control" required autocomplete="disable"/>
                            </div>
                            ...
                            <div class="pt-1 mb-4">
                              <button class="btn btn-dark btn-lg btn-block" type="submit" value="Registrarse">Registrarse</button>
                            </div>
